# Wake-On-LAN ![Matrix Build Status](https://github.com/nikeee/wake-on-lan/workflows/Matrix%20Build/badge.svg) [![NuGet version](https://img.shields.io/nuget/v/WakeOnLan.svg)](https://nuget.org/packages/WakeOnLan)
